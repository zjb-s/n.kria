...
function Data:get_page_val(track,page,name) 
	return params:get(name..'_'..page..'_t'..track..'_p'..self.pattern) 
end
...
function Data:set_page_val(track,page,name,new_val) 
	params:set(name..'_'..page..'_t'..track..'_p'..self.pattern,new_val) 
end
...
function Data:delta_page_val(track,page,name,d) 
	params:delta(name..'_'..page..'_t'..track..'_p'..self.pattern,d) 
end
